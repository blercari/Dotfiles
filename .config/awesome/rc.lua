...
beautiful.init("~/.config/awesome/themes/custom.lua")
...
globalkeys = gears.table.join(
    ...
    -- awful.key({ modkey,           }, "space", function () mykeyboardlayout.next_layout() end,
              -- {description = "next keyboard layout", group = "misc"}),
...
-- Start Compton (options prevent tearing, 'false' prevents cursor stuck loading on startup)
awful.util.spawn("compton --backend glx --paint-on-overlay --vsync opengl-swc", false)
